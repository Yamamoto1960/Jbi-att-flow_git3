...
def get_args():
    ...
    #source_dir = os.path.join(home, "data", "suzuki_data","split_suzukidata")
    source_dir = os.path.join(home, "data", "suzuki_data","split_dev_test")
    #source_dir = os.path.join(home, "data", "suzuki_data")
...
def create_all(args):
    ...
    train_data = json.load(codecs.open(train_path, 'r', encoding="utf-8"))
    dev_path = os.path.join(args.source_dir, args.dev_name)
    dev_data = json.load(codecs.open(dev_path, 'r', encoding="utf-8"))
...
def save(args, data, shared, data_type):
    ...
    json.dump(shared, open(shared_path, 'w'),ensure_ascii=False)
